...
#INICIAR SESION
    ...
    with tab2:
        ...
        if st.session_state["mode"] == "login":
            ...
            if st.button("Crear Cuenta", key="btn_register", use_container_width=True):
...
if st.session_state.get("APP_PAGE") == "CUENTA_P1":
    ...
    with col2:
        ...
        with st.form("cambiar_password_form"):
            ...
            btn_cambiar = st.form_submit_button("💾 Cambiar Contraseña", type="primary", use_container_width=True)
